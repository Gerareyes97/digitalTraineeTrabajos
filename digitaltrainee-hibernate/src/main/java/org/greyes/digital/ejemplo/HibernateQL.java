...
import org.greyes.digital.ejemplo.dominio.ClienteDto;
...
public class HibernateQL {
    public static void main(String[] args) {
        ...
        List<ClienteDto> clientesDto = em.createQuery("select new org.greyes.digital.ejemplo.dominio.ClienteDto(c.nombre, c.apellido) from Cliente c", ClienteDto.class)
                .getResultList();
